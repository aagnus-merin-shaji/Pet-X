...
shelterRoutes.put("/save", upload.fields([{ name: "facilityImages", maxCount: 1 }]),shelterController.upsertShelterProfile);
...
shelterRoutes.get("/everyanimal", userAuthentication,shelterController.getAllAnimals);
